...
本站教程从服务器独立媒体目录加载固定的 MP4，不依赖 B站播放地址。视频文件不存放在 GitHub 仓库或应用发布包内；部署配置见 [教程视频托管](../../../docs/TUTORIAL_VIDEO_HOSTING.md)。文件由贡献者提供；贡献者已确认拥有或已获得本站转载授权。此确认不表示第三方视频改用本仓库的软件许可证，第三方素材权利仍归原权利人。
