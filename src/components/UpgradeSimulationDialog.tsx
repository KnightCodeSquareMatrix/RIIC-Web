...
export type UpgradeSimulationSelection = Pick<OperBoxEntry, "id" | "name" | "rarity">;
...
export function UpgradeSimulationDialog({ operbox, baseline, disabled = false, onSimulate }: { operbox: OperBoxEntry[]; baseline: PublicPlanData; disabled?: boolean; onSimulate: (operators: UpgradeSimulationSelection[]) => Promise<PublicPlanData>; }) {
