          ...
          <section aria-labelledby="settings-display-title">
            ...
            <div className="flex items-center justify-between gap-6 border-t border-border/60 pt-4">
              <Label htmlFor="highlight-no-layout-skill" className="grid min-w-0 gap-1">
                ...
                <span className="font-normal text-sm text-muted-foreground">{en ? "Highlight operators with no usable infrastructure skill in the current layout. Off by default." : "高亮当前基建布局内没有可用基建技能的干员，默认关闭。"}</span>
              </Label>
